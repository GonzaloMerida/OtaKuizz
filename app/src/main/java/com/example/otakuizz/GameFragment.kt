...
class GameFragment : Fragment() {
    ...
    //la primera respuesta de cada pregunta es la correcta por convención, para no liarte a la hora
    //de probar
    ...
    //para mezclar las respuestas y que no sea la correcta la primera de la lista (shuffle)
    lateinit var answers: MutableList<String>
    //índice de la pregunta en la que me encuentro
    private var questionIndex = 0
    //fórmula para establecer cuántas preguntas se necesitan para jugar
    ...
    private fun setQuestion() {
        ...
        //poner título a la barra superior de la pantalla
